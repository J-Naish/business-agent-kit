---
name: visual-design
description: For substantial visual design work — creating or materially redesigning a website, landing page, app UI, dashboard, deck, PDF, poster, image creative, email, or video — or when establishing a new visual system, brand surface, or design language. Trigger on explicit asks for design direction, a design system, UI/UX review, art direction, typography, color palette, layout exploration, motion strategy, or look-and-feel; on vague visual asks like "make it feel more premium", "needs more polish", "the hero looks off"; and on first-impression surfaces (marketing pages, pitch decks, onboarding flows). Skip for narrow tweaks inside an existing design system: copy edits, small CSS adjustments, accessibility fixes that preserve the design.
---
